...
function CreateProductForm() {
  ...
  const onChange = (e: React.ChangeEvent<any>) => {
    ...
    const validationErrors = productFormValidations({
      ...product,
      [e.target.name]: value,
    });
      ...
      <div className="flex flex-col items-center h-full w-3/12 bg-gray-100 mx-2 border border-gray-300 rounded-lg shadow">
        ...
        >
          ...
          <div className="flex-col justify-start w-full">
            ...
            />
            {errors.name && (
              <p className="text-red-500 text-xs mb-1 ml-2">{errors.name}</p>
            )}
          </div>
          <div className="flex-col justify-start w-full">
            <label className="block mb-2 ml-2 text-sm font-medium dark:text-white">
            ...
            />
            {errors.price && (
              <p className="text-red-500 text-xs mb-1 ml-2">{errors.price}</p>
            )}
          </div>
          <div className="flex-col justify-start w-full">
            <label className="block mb-2 ml-2 text-sm font-medium dark:text-white">
            ...
            {errors.stock && (
              <p className="text-red-500 text-xs mb-1 ml-2">{errors.stock}</p>
            )}
          </div>
          <div className="flex-col justify-start w-full">
            <label className="block mb-2 ml-2 text-sm font-medium dark:text-white">
            ...
            />
            {errors.description && (
              <p className="text-red-500 text-xs mb-1 ml-2">
                {errors.description}
              </p>
            )}
          </div>
          <div className="flex-col justify-start w-full">
            ...
            {errors.image && (
              <p className="text-red-500 text-xs mb-1 ml-2">{errors.image}</p>
            )}
          </div>
          <div className="flex-col justify-start w-full">
            <label className="block mb-2 ml-2 text-sm font-medium dark:text-white">
            ...
            {errors.Type && (
              <p className="text-red-500 text-xs mb-1 ml-2">{errors.Type}</p>
            )}
          </div>
          {selectedType !== 0 && (
            <div className="flex-col justify-start w-full">
              ...
              >
                <option value="" disabled>
                  Selecciona el Sub-tipo de producto
                </option>
          ...
          {isSubtypeSelected && selectedSubtype !== "" && (
            <div className="flex-col justify-start w-full">
              ...
              >
                <option value={0} disabled>
                  Selecciona la Medida del Producto
                </option>
                {metric.map((metric) => (
