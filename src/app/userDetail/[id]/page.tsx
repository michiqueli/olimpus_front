...
export default function UserDetail() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen" style={{ marginTop: "-2rem" }}>
      {/* Tarjeta de perfil del usuario */}
      <div className="flex flex-col items-center rounded-lg bg-cover w-96 h-80 bg-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:max-w-xl md:flex-row" style={{ backgroundImage: 'url("/tarjetaDeUsuario1.jpg")' }}>
      ...
      {/* Botón debajo de la tarjeta con estilo en línea */}
      {usuarios && (
        <button
