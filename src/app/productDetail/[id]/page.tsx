        ...
        <div className="flex flex-row justify-end mt-4 bg-gray-50 ">   
          ...
          <div>
            ...
            <div className="flex items-center mt-4 ml-40 text-lg border font-bold border-gray-300 w-4/12 p-4 rounded-full ">
              ...
              <button onClick={handleAddToCart}  className="my-20 ml-80 text-xl bg-yellow-200 hover:bg-yellow-300 text-black font-normal py-2 px-4 rounded-full">Agregar al carrito</button>
          </div>
        </div>  
      </div>
        {isOpen && (
