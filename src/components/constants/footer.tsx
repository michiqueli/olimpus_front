        ...
        <footer className="bg-yellow-300 relative w-[100%] items-center text-center">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 w-[80%]">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    <a href="mailto:olimpusshop@correo.com" className="text-black-400 hover:text-blue-800">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=542994130232" className="text-black-400 hover:text-blue-800">
